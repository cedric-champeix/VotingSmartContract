        ...
        <CardContent className='grid grid-cols-1 md:grid-cols-2 p-0'>
          <div className='flex flex-col items-center justify-center p-10'>
            ...
            <Button
              ...
              className='bg-primary text-primary-foreground dark:bg-custom-1 dark:text-primary-foreground hover:bg-accent dark:hover:bg-custom-1 px-6 py-3 rounded-lg shadow-md'
            >
              {t('login.button')}
            </Button>
          </div>
          ...
          <div className='relative hidden md:block bg-muted'>
            <img src='/images/logo-vert.png' alt='Login Illustration' className='w-full h-full object-cover' />
          </div>
        </CardContent>
      </Card>
    </div>
