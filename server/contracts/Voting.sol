...
contract Voting is Ownable {
    ...
    /**
     * @dev Initializes the contract by setting default values for the current vote.
     */
    constructor() {
    ...
    // ===================== MODIFIERS =====================
    /**
     * @dev Ensures that the sender is a registered voter and eligible to vote in the current cycle.
     */
    ...
    function tallyVotes() external onlyOwner {
        ...
        // Check if there were enough participants to validate the vote
